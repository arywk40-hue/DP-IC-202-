...
\author{
\IEEEauthorblockN{Ariyan Bhakat, Jenish Gandhi, Anushka Sinha, Aditi Priya,
Vishal Rajpurohit, Abhinav P. Nair}
\IEEEauthorblockA{
...
50,000 including shared NRE, calibration jigs, spare sensors, and
contingency, against INR 1,20,000--2,50,000 per unit for comparable
commercial stations. We conclude with a scaling and optimization roadmap
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{edge_ai_flowchart.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{firmware_architecture.png}
...
\midrule
\textbf{Total} & \textbf{Complete research-grade node(s)} & \textbf{19,129} & \textbf{50,000} \\
\bottomrule
\end{tabular}
\end{table}
...
INR 50,000 including shared NRE, calibration jigs, spare sensors, and
contingency --- itself substantially lower than a single commercial unit
(INR 1.2--2.5 Lakhs). Scaling the same
