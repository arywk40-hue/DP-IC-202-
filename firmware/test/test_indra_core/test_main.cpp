...
void run_tests() { UNITY_BEGIN(); RUN_TEST(test_first_sample_requires_pressure_history); RUN_TEST(test_exact_order_and_not_ready); RUN_TEST(test_missing_input_rejected); UNITY_END(); }
}
#ifdef ARDUINO
#include <Arduino.h>
