...
\begin{itemize}
    \item \textbf{Temperature/Humidity:} Vaisala HMP155 (±0.2°C, ±2\% RH) - \$800
    \item \textbf{Barometer:} Vaisala PTB330 (±0.3 hPa) - \$1,200
    \item \textbf{Wind:} Gill WindSonic 3D ultrasonic (±2\%, no moving parts) - \$1,000
    \item \textbf{Visibility/Fog:} Vaisala PWD22 (forward scatter, 10m-75km) - \$4,500
    \item \textbf{Cloud Ceiling:} Campbell Scientific CS135 ceilometer (laser) - \$3,000
    \item \textbf{Precipitation:} Vaisala DRD11A optical rain gauge - \$1,500
    \item \textbf{Solar Radiation:} Apogee SP-110 pyranometer - \$300
    \item \textbf{Lightning:} Boltek LD-250 detector (0-40 km) - \$400
\end{itemize}

\textit{Computing \& Communication:}
\begin{itemize}
    \item \textbf{Edge AI:} NVIDIA Jetson Orin Nano 8GB - \$500
    \item \textbf{Data Logger:} Campbell Scientific CR1000X - \$2,000
...
\subsection{Budget Estimate (Single Unit Prototype)}

\begin{itemize}
    \item Meteorological Sensors: \$12,700
    \item Edge Computing (Jetson + Data Logger): \$2,500
    ...
    \item \textbf{Total Single Unit: \$19,000}
\end{itemize}

\textit{Note: Production cost will drop to \$12k-15k at scale (100+ units) due to bulk procurement and indigenization}

\textbf{Field Deployment Budget (3 Test Stations):}
\begin{itemize}
    \item 3× Weather Stations: \$57,000
    \item Travel \& Installation: \$5,000
    \item 6-month Field Trial Support: \$8,000
    \item \textbf{Total Field Trial: \$70,000}
\end{itemize}
