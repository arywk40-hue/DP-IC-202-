...
ml/docs/                        # ML-specific docs now live with the ML work
...
| [ML_INFERENCE.md](../../ml/docs/ML_INFERENCE.md) | XGBoost model format, inference API |
...
|-----------|------|----------------|
| `common` | `other/firmware/components/common/` | Shared types, error codes |
| `sensors` | `other/firmware/components/sensors/` | 11 sensor drivers (I2C/UART/ADC/1-Wire) |
| `lora` | `other/firmware/components/lora/` | SX1276 SPI driver |
| `mesh` | `other/firmware/components/mesh/` | Multi-hop mesh (CRC8, TTL, ACK, heartbeat) |
| `ml` | `other/firmware/components/ml/` | XGBoost inference + auto-generated model |
...
Generated headers (in `other/firmware/components/ml/include/`):
...
cd ../firmware/          # from other/docs/ into other/firmware/
